...
// If it's absent (CI, fresh clones), release builds fall back to the debug key
// so the project still builds — only locally-signed releases are installable as
// updates over a prior release. See ../../Documentation/KEYSTORE.md (local).
...
android {
    namespace = "io.github.tifandrei42.featherlog"
